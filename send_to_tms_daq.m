function [varargout] = send_to_tms_daq(command, command_param, show_fprintf_feedback)
...
% 04/22/08 initial version
    ...
    all_bits_high = 255;
    bits_for_sweep_trigger = 2;
    bits_for_tms_trigger = 1;
...
%% tms or sweep trigger            
        case {'tms', 'sweep'}
            ...
            DaqDOut(daq_id, port_b, '00000000');
